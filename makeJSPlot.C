...
void makeJSPlot(char *infname = "output-0.root")
{
   ...
   hClosurePt_MergedGeneral2->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosureEta_MergedGeneral2->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosurePhi_MergedGeneral2->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosureDR_MergedGeneral2->SetAxisRange(0.8,1.2,"Y");
   ...
   TCanvas *cClosureMergedGeneral2JSEtaSub = new TCanvas("cClosureMergedGeneral2JSEtaSub","JSEtaSub",600,600);   
   TH1F *hClosureJSEtaSub_MergedGeneral2 = (TH1F*) inf->Get("hClosureJSEtaSub_MergedGeneral2");
   hClosureJSEtaSub_MergedGeneral2->SetAxisRange(0.8,1.2,"Y");
   TLine *lJSEtaSub_MergedGeneral2 = new TLine(hClosureJSEtaSub_MergedGeneral2->GetBinLowEdge(1),1,hClosureJSEtaSub_MergedGeneral2->GetBinLowEdge(hClosureJSEtaSub_MergedGeneral2->GetNbinsX()+1),1);
   hClosureJSEtaSub_MergedGeneral2->Draw();
   lJSEtaSub_MergedGeneral2->Draw();
   cClosureMergedGeneral2JSEtaSub->SaveAs("fig/ClosureMergedGeneral2_JSEtaSub.gif");
   cClosureMergedGeneral2JSEtaSub->SaveAs("fig/ClosureMergedGeneral2_JSEtaSub.C");
   cClosureMergedGeneral2JSEtaSub->SaveAs("fig/ClosureMergedGeneral2_JSEtaSub.pdf");
   ...
   TCanvas *cMergedGeneral2JSEtaSub = new TCanvas("cMergedGeneral2JSEtaSub","JSEtaSub",600,600);   
   TH1F *hCorrectedJSEtaSub_MergedGeneral2 = (TH1F*) inf->Get("hCorrectedJSEtaSub_MergedGeneral2");
   TH1F *hRecoJSEtaSub_MergedGeneral2 = (TH1F*) inf->Get("hRecoJSEtaSub_MergedGeneral2");
   TH1F *hGenJSEtaSub_MergedGeneral2 = (TH1F*) inf->Get("hGenJSEtaSub_MergedGeneral2");
   divideBinWidth(hGenJSEtaSub_MergedGeneral2);
   divideBinWidth(hRecoJSEtaSub_MergedGeneral2);
   divideBinWidth(hCorrectedJSEtaSub_MergedGeneral2);

   hGenJSEtaSub_MergedGeneral2->SetLineColor(4);
   hGenJSEtaSub_MergedGeneral2->SetMarkerColor(4);
   hGenJSEtaSub_MergedGeneral2->SetFillStyle(3001);
   hGenJSEtaSub_MergedGeneral2->SetFillColor(4);
   hCorrectedJSEtaSub_MergedGeneral2->SetLineColor(4);
   hCorrectedJSEtaSub_MergedGeneral2->SetMarkerColor(4);
   hGenJSEtaSub_MergedGeneral2->Draw("hist");
   hCorrectedJSEtaSub_MergedGeneral2->Draw("same");
   hRecoJSEtaSub_MergedGeneral2->Draw("same");
   hGenJSEtaSub_MergedGeneral2->SetAxisRange(0,hGenJSEtaSub_MergedGeneral2->GetMaximum()*1.5,"Y");
   makeHistTitle(hGenJSEtaSub_MergedGeneral2,"","(Sim)Track #Delta R","Arbitrary Unit");
   TLegend *legJSEtaSub = myLegend(0.2,0.7,0.4,0.9);
   legJSEtaSub->AddEntry(hGenJSEtaSub_MergedGeneral2,"Gen p_{T}","lf");
   legJSEtaSub->AddEntry(hRecoJSEtaSub_MergedGeneral2,"Reco p_{T}","pl");
   legJSEtaSub->AddEntry(hCorrectedJSEtaSub_MergedGeneral2,"Corrected p_{T}","pl");
   legJSEtaSub->Draw();

   cMergedGeneral2JSEtaSub->SaveAs("fig/MergedGeneral2_JSEtaSub.gif");
   cMergedGeneral2JSEtaSub->SaveAs("fig/MergedGeneral2_JSEtaSub.C");
   cMergedGeneral2JSEtaSub->SaveAs("fig/MergedGeneral2_JSEtaSub.pdf");
   ...
   hClosurePt_MergedGeneral->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosureEta_MergedGeneral->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosurePhi_MergedGeneral->SetAxisRange(0.8,1.2,"Y");
   ...
   hClosureDR_MergedGeneral->SetAxisRange(0.8,1.2,"Y");
   ...
   TCanvas *cClosureMergedGeneralJSEtaSub = new TCanvas("cClosureMergedGeneralJSEtaSub","JSEtaSub",600,600);   
   TH1F *hClosureJSEtaSub_MergedGeneral = (TH1F*) inf->Get("hClosureJSEtaSub_MergedGeneral");
   hClosureJSEtaSub_MergedGeneral->SetAxisRange(0.8,1.2,"Y");
   TLine *lJSEtaSub_MergedGeneral = new TLine(hClosureJSEtaSub_MergedGeneral->GetBinLowEdge(1),1,hClosureJSEtaSub_MergedGeneral->GetBinLowEdge(hClosureJSEtaSub_MergedGeneral->GetNbinsX()+1),1);
   hClosureJSEtaSub_MergedGeneral->Draw();
   lJSEtaSub_MergedGeneral->Draw();
   cClosureMergedGeneralJSEtaSub->SaveAs("fig/ClosureMergedGeneral_JSEtaSub.gif");
   cClosureMergedGeneralJSEtaSub->SaveAs("fig/ClosureMergedGeneral_JSEtaSub.C");
   cClosureMergedGeneralJSEtaSub->SaveAs("fig/ClosureMergedGeneral_JSEtaSub.pdf");
   ...
   TCanvas *cMergedGeneralJSEtaSub = new TCanvas("cMergedGeneralJSEtaSub","JSEtaSub",600,600);   
   TH1F *hCorrectedJSEtaSub_MergedGeneral = (TH1F*) inf->Get("hCorrectedJSEtaSub_MergedGeneral");
   TH1F *hRecoJSEtaSub_MergedGeneral = (TH1F*) inf->Get("hRecoJSEtaSub_MergedGeneral");
   TH1F *hGenJSEtaSub_MergedGeneral = (TH1F*) inf->Get("hGenJSEtaSub_MergedGeneral");
   divideBinWidth(hGenJSEtaSub_MergedGeneral);
   divideBinWidth(hRecoJSEtaSub_MergedGeneral);
   divideBinWidth(hCorrectedJSEtaSub_MergedGeneral);

   hGenJSEtaSub_MergedGeneral->SetLineColor(4);
   hGenJSEtaSub_MergedGeneral->SetMarkerColor(4);
   hGenJSEtaSub_MergedGeneral->SetFillStyle(3001);
   hGenJSEtaSub_MergedGeneral->SetFillColor(4);
   hCorrectedJSEtaSub_MergedGeneral->SetLineColor(4);
   hCorrectedJSEtaSub_MergedGeneral->SetMarkerColor(4);
   hGenJSEtaSub_MergedGeneral->Draw("hist");
   hCorrectedJSEtaSub_MergedGeneral->Draw("same");
   hRecoJSEtaSub_MergedGeneral->Draw("same");
   hGenJSEtaSub_MergedGeneral->SetAxisRange(0,hGenJSEtaSub_MergedGeneral->GetMaximum()*1.5,"Y");
   makeHistTitle(hGenJSEtaSub_MergedGeneral,"","(Sim)Track #Delta R (GeV/c)","Arbitrary Unit");
   legJSEtaSub->Draw();

   cMergedGeneralJSEtaSub->SaveAs("fig/MergedGeneral_JSEtaSub.gif");
   cMergedGeneralJSEtaSub->SaveAs("fig/MergedGeneral_JSEtaSub.C");
   cMergedGeneralJSEtaSub->SaveAs("fig/MergedGeneral_JSEtaSub.pdf");
